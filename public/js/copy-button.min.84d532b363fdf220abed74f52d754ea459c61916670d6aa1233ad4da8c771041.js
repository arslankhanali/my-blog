function addCopyButtons(e){document.querySelectorAll("pre > code").forEach(function(t){var o,n=document.createElement("button");n.className="copy-code-button",n.type="button",n.innerHTML=`
